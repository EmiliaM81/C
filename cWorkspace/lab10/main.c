...
int main(void)
{
    ...
    add(&list, &student1, students_cmp);
    add(&list, &student2, students_cmp);
    add(&list, &student3, students_cmp);


    print_list(&list, print_student);

    remove_data(&list, students_cmp, &student1);
    ...
    get_data(&list, students_cmp,&student2);
